...
const API_THEMES = [
    (
        ...
        symbols=[
            ...
            :time!, :state!, :control!, :variable!, :dynamics!, :objective!,
            Symbol("CTModels.Building.constraint!"), :time_dependence!,
            :build, :build_initial_guess,
        ],
    ),
    (
        ...
        symbols=[
            ...
            :state_dimension, :state_name, :state_components,
            :control_dimension, :control_name, :control_components,
            :variable_dimension, :variable_name, :variable_components,
            :components, :dimension, :name,
            # Generic component accessors
            :index, :expression, :criterion,
            # Times
            :initial_time, :final_time, :times, :time_name,
            ...
            # Constraints
            Symbol("CTModels.Models.constraint"), :constraints,
            :path_constraints_nl, :boundary_constraints_nl,
            :state_constraints_box, :control_constraints_box,
            :variable_constraints_box, :dim_path_constraints_nl,
            :dim_boundary_constraints_nl, :dim_state_constraints_box,
            :dim_control_constraints_box, :dim_variable_constraints_box,
            # Definition
            :definition, :has_abstract_definition, :is_abstractly_defined,
            # Traits
            :is_autonomous, :is_nonautonomous, :is_variable, :is_nonvariable,
            :has_variable, :has_control, :is_control_free,
        ],
    ),
    (
    ...
    (
        id="options", title="Options and strategies",
        symbols=[
            :route_to, :bypass, :force,
            :options, :option_names, :option_type, :option_default,
            :option_defaults, :option_description, :option_value,
            :option_source, :has_option,
            :is_user, :is_default, :is_computed,
            :id, :metadata, :create_registry, :strategy_ids, :type_from_id,
            Symbol("CTBase.Strategies.parameter"),
            :default_parameter, :available_parameters,
            :CPU, :GPU,
            :describe,
        ],
    ),
    (
        ...
        symbols=[
            # Trajectories
            :state, :control, :costate,
            Symbol("CTModels.Solutions.variable"), :time_grid,
            # Objective
            Symbol("CTModels.Solutions.objective"),
            # Status
            :status, :message, :successful, :iterations,
            :constraints_violation, :infos, :model,
            # Emptiness
    ...
    (
        ...
        symbols=[
            ...
            :SciML, :AbstractIntegrator, :AbstractIntegrationResult,
            :final_state, :evaluate_at,
        ],
    ),
    (
        id="geometry", title="Geometry",
        symbols=[
            :ad, :Lift, :Poisson, Symbol("∂ₜ"),
            :dg_ad_backend, Symbol("dg_ad_backend!"),
            Symbol("@Lie"),
        ],
    ),
    (
        ...
        symbols=[
            # Vector fields
            :AbstractVectorField, :VectorField, :AbstractControlledVectorField,
            :ControlledVectorField, :ComposedVectorField, :controlled_vector_field,
            # Hamiltonians
            ...
            :AbstractPathConstraint, :PathConstraint, :StateConstraint,
            :ControlConstraint, :MixedConstraint, :AbstractMultiplier, :Multiplier,
        ],
    ),
    (
        id="io", title="Plotting and I/O",
        symbols=[:plot, Symbol("plot!"), :export_ocp_solution, :import_ocp_solution],
    ),
    (
        id="qualified", title="Qualified access",
        symbols=[
            Symbol("CTModels.Building.PreModel"), Symbol("CTModels.Models.Model"),
            Symbol("CTModels.Solutions.Solution"), Symbol("CTModels.Solutions.AbstractSolution"),
            Symbol("CTModels.Init.AbstractInitialGuess"), Symbol("CTModels.Init.InitialGuess"),
            Symbol("CTSolvers.Modelers.ADNLP"), Symbol("CTSolvers.Modelers.Exa"),
            Symbol("CTSolvers.Solvers.Ipopt"), Symbol("CTSolvers.Solvers.MadNLP"),
            Symbol("CTSolvers.Solvers.MadNCL"), Symbol("CTSolvers.Solvers.Knitro"),
            Symbol("CTSolvers.Solvers.Uno"),
            Symbol("CTSolvers.DOCP.AbstractDiscretizer"), Symbol("CTSolvers.DOCP.DiscretizedModel"),
            Symbol("CTSolvers.Modelers.AbstractNLPModeler"), Symbol("CTSolvers.Solvers.AbstractNLPSolver"),
            :LiftedHamiltonianFunction,
            Symbol("CTBase.Exceptions.CTException"), Symbol("CTBase.Exceptions.IncorrectArgument"),
            Symbol("CTBase.Exceptions.PreconditionError"), Symbol("CTBase.Exceptions.NotImplemented"),
            Symbol("CTBase.Exceptions.ParsingError"), Symbol("CTBase.Exceptions.AmbiguousDescription"),
            Symbol("CTBase.Exceptions.ExtensionError"),
            Symbol("CTBase.Core.NotProvided"), Symbol("CTBase.Core.NotProvidedType"),
            Symbol("CTBase.Core.ctNumber"),
            Symbol("CTBase.Strategies.AbstractStrategy"), Symbol("CTBase.Strategies.StrategyRegistry"),
            Symbol("CTBase.Strategies.StrategyMetadata"), Symbol("CTBase.Strategies.StrategyOptions"),
            Symbol("CTBase.Strategies.RoutedOption"), Symbol("CTBase.Strategies.BypassValue"),
...
let
    ...
    qualified_bare = Set(_bare_name(s) for s in first(t.symbols for t in API_THEMES if t.id == "qualified"))
