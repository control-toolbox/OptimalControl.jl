...
function Flow(hv::HamiltonianVectorField, description...; kwargs_Flow...)
   ...
   TBW
   """
    function f(t0::Time, x0::State, p0::Adjoint, t::Time, λ...; method=__method(), abstol=__abstol(), reltol=__reltol(), saveat=__saveat(), kwargs...)
        sol = f((t0, t), x0, p0, λ..., method=method, abstol=abstol, reltol=reltol, saveat=saveat; kwargs..., kwargs_Flow...)
        n = size(x0, 1)
