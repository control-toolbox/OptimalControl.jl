...
The package serves educational purposes through [Tutorials.jl](https://control-toolbox.org/Tutorials.jl) covering topics from linear-quadratic regulators to Model Predictive Control. These resources are used in academic courses and workshops; the package was notably presented at JuliaCon 2023 [@caillau2023juliacon], with the documentation serving as the presentation support. [OptimalControlProblems.jl](https://control-toolbox.org/OptimalControlProblems.jl) provides standardized test problems formulated in both OptimalControl DSL and JuMP, enabling systematic performance comparisons through [CTBenchmarks.jl](https://control-toolbox.org/CTBenchmarks.jl).
